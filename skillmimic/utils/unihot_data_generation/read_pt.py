...
HAND_CONFIGS = {
    'mano': {
        'xml_path': "skillmimic/data/assets/mjcf/rhand_mano_pk.xml",
        'key_bodies': [
    ...
    'shadow': {
        'xml_path': "skillmimic/data/assets/mjcf/shadow/shadow_hand_kp.xml", 
        'key_bodies': [
    ...
    'allegro': {
        'xml_path': "skillmimic/data/assets/mjcf/allegro/allegro_hand_pk.xml",
        'key_bodies': [
